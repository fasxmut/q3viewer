...
void q3viewer::q3_map_loader::load(const std::string & pk3_name, const std::string & bsp_name)
{
	if (
		pk3_name == ""
		||
	...
	{
		throw std::runtime_error{R"====(These path are not allowed for pk3 archive:
			""
			"."
			"./"
			".."
